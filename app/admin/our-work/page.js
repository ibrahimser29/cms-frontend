...
export default function OurWorkEditPage() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/homepage/our-work`)
      .then((r) => r.json())
      .then((json) => {
  ...
  async function handleCarouselUpload(e) {
    ...
    try {
      ...
      const res = await fetchWithAuth(`${API_BASE}/homepage/admin/our-work/images`, {
        method: 'POST',
        body: fd,
      });
      if (!res.ok) {
  ...
  async function handleSave(e) {
    ...
    setSaving(true);
    try {
      const res = await fetchWithAuth(`${API_BASE}/homepage/admin/our-work`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div className={styles.page}>
      <div className={styles.breadcrumb}>
        ...
        <span>Our Work Section</span>
      </div>

      <h1 className={styles.heading}>Edit Our Work Section</h1>
